...
public class FtlPackageImpl extends EPackageImpl implements FtlPackage {
	...
	public void createPackageContents() {
		...
		createEReference(transformEClass, TRANSFORM__INPUTS);
		createEReference(transformEClass, TRANSFORM__INSTRUCTION);
		createEReference(transformEClass, TRANSFORM__OUTPUT);
	...
	public void initializePackageContents() {
		...
		initEReference(getTransform_Inputs(), this.getStream(), null, "inputs", null, 1, -1, Transform.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTransform_Output(), this.getOutputStream(), null, "output", null, 1, 1, Transform.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
