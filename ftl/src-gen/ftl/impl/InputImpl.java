 ...
 * </p>
 * <ul>
 *   <li>{@link ftl.impl.InputImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class InputImpl extends MinimalEObjectImpl.Container implements Input {
	...
	protected EClass eStaticClass() {
		return FtlPackage.Literals.INPUT;
	}
	...
	public EList<String> getPath() {
		if (path == null) {
			path = new EDataTypeUniqueEList<String>(String.class, this, FtlPackage.INPUT__PATH);
		}
		return path;
	}
